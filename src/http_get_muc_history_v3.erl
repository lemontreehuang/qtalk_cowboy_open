-module(http_get_muc_history_v3).
...
%        Time1 = handle_time(User,Host1,Args),
         	...
         	Loacl_Res = 
                ...
                -1  ->
                    ...
                    lists:flatmap(fun({Muc,D}) ->
                                T1 = ejb_public:format_time(D),
                             case catch ejb_odbc_query:get_muc_msg_info4(Muc,T1) of
                ...
                _ ->
    				...
    				case catch ejb_odbc_query:get_muc_history_v2(User,Host1,Domain,T,Num) of
		...
		Domain_Res =
			case catch  pg_odbc:sql_query(<<"ejb_http_server">>,
			[<<"select muc_name,domain from user_register_mucs where username = '">>,User,<<"' and host = '">>,Host1,
					<<"' and  domain <> '">>,Domain,<<"'">>]) of
...
get_user_muc_and_last(User,Domain,Time) ->
	case catch  pg_odbc:sql_query(<<"ejb_http_server">>,
		[<<"select muc_name,date from muc_room_users  where username = '">>,User,<<"' and host = '">>,Domain,<<"';">>]) of
